...
return(
  ...
  <Container className="myDiv">
    ...
    <input className="mySearchBar-inp" type="text" placeholder="Search" />
    
    <button className="btn myButton-btn fas fa-search" style={{backgroundColor: "white", color : "white" }} type="submit">
